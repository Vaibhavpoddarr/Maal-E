...
cam = cv2.VideoCapture("/home/siddarth/rosworkspace/src/maale/test.mp4")

model = cv2.dnn.readNet("/home/siddarth/rosworkspace/src/maale/cfg/yolo_malle_last.weights",
                        "/home/siddarth/rosworkspace/src/maale/cfg/yolo_malle.cfg")
classes = ["ripe","unripe"]
